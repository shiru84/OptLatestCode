...
public class OP2GBS21307002686 {
    ...
    static String XLS = "/exel/OP2GBS21307002686/data.xlsx";
...
//#A836-slim > div > h2
            ...
            WebElement meta = driver.findElement(By.cssSelector("#folder1 > div.opened > div:nth-child(1) > span:nth-child(2)"));
            String meta_text = meta.getText();
            System.out.println("Founud -  "+meta_text);
